      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 p-12 items-center justify-center relative overflow-hidden">
        ...
        <div className="w-full max-w-lg relative z-10 space-y-8">
          ...
          <div className="flex items-center gap-3">
            ...
            <span className="text-2xl font-extrabold tracking-tight text-white">CNT Reservation</span>
          </div>
          ...
          <div className="space-y-3">
            ...
            <p className="text-lg text-slate-300 leading-relaxed">
              Sign in to your account to continue managing tickets, collaborating with your team, and keeping operations running smoothly.
            </p>
          </div>
          ...
          <div className="space-y-4 mt-8">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-slate-400">
                  Streamline your workflow and resolve issues quickly with our intuitive interface.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-slate-400">
                  Work together seamlessly with real-time updates and shared task management.
                </p>
              </div>
            </div>
          </div>
